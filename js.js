...
var darkButton = document.querySelector("#darkButton");darkButton.addEventListener("click", function() {body.classList.toggle("bodyDark");botaoMais.classList.toggle("botaoMaisDark");descricao.classList.toggle("descricaoDark");body.classList.toggle("backgroundDark");bottomRight.classList.toggle("bottomRightDark");gradientContainer.classList.toggle("gradientContainerDark");});
