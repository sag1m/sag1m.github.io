...
var mais = [
  ...
  //CÓPIA DO HTML:
  '<div style="border-left:0.5px solid red; padding-left:10px"><p style="line-height:3rem;font-size:2rem">Olá<br>Sou o Miguel Sousa,<br>designer de comunicação multimédia. </p><p style="margin:10px 0 0 0;">Vê vários trabalhos que fiz neste site que programei.</p><span onclick="toggleCaixa()" style="cursor: pointer;" id="sobre">Ler mais⬇</span><div style="padding-top:3px;display:none" id="caixaTexto" class="caixa-texto"><p>Gosto de me cansar no ginásio. <br>Prefiro usar a bicicleta como meio de transporte.<br>Quando não chove, cultivo catnip para os meus gatos e suculentas.<br>Talvez passe demasiado tempo no computador.</p></div><br><br><p style="font-weight:700">Disponível para colaborar</p><p style="padding-bottom:1.5rem">Email:<a href="mailto:mnamoras@outlook.pt">mnamoras@outlook.pt</a></p><span id="darkButton">dark-mode&#9788</span></div>',
