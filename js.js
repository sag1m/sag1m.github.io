...
var mais = [
  ...
  //CÓPIA DO HTML:
  '<div style="border-left:0.5px solid red; padding-left:10px"><p style="line-height:3rem;font-size:2rem"><span lang="und" translate="no" id="O" style="font-weight:600;" >&#9786</span><span lang="und" translate="no" >lá</span><br>Sou o Miguel Sousa,<br>designer de comunicação multimédia. </p><p style="margin:10px 0 0 0;">Tenho vários trabalhos neste site que programei.<br>Ainda estou a atualizar os trabalhos e o site.</p><br><span onclick="toggleCaixa()" style="cursor: pointer;" id="sobre">&#11015 Ler mais </span> <span id="darkButton"> <span style="margin-left:20px;" >&#9788</span> modo-escuro</span>                          <a href="https://translate.google.com/translate?hl=en&sl=auto&tl=en&u=https://sag1m.github.io/" target="_blank" style="margin-left:20px; cursor:pointer; text-decoration:none; font-weight:500; font-style: italic;">             <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" stroke="black" stroke-width="2"/><path d="M12 2C15 5 17 10 17 12C17 14 15 19 12 22" stroke="black" stroke-width="2"/><path d="M12 2C9 5 7 10 7 12C7 14 9 19 12 22" stroke="black" stroke-width="2"/><path d="M2 12H22" stroke="black" stroke-width="2"/></svg> English</a>                                   <div style="padding-top:3px;display:none" id="caixaTexto" class="caixa-texto"><img style="height: 200px;position: absolute;left: 900px;top: 200px;"id=""src="test02.png"alt="Auto retrato sobre-exposto e demasiado editado"><p>Gosto de me cansar no ginásio. <br>Prefiro usar a bicicleta como meio de transporte.<br>Quando não chove, cultivo catnip para os meus gatos e suculentas.<br>Talvez passe demasiado tempo no computador.</p></div><br><br><p style="font-weight:700">Disponível para colaborar</p><a style="text-decoration:;" href="mailto:mnamoras@outlook.pt" onmouseover="document.getElementById(&quot;coracao&quot;).innerHTML=&quot;❤&quot;" onmouseout="document.getElementById(&quot;coracao&quot;).innerHTML=&quot;✉&quot;"><span id="coracao">&#9993;</span> mnamoras@outlook.pt</a></div>',
